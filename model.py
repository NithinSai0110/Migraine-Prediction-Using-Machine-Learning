...
# feature selection
selected_features = ['Age', 'Duration', 'Intensity', 'Nausea', 'Vomit', 'Phonophobia', 'Photophobia', 'Visual',
                     'Sensory', 'Vertigo']
...
for iteration in range(num_iterations):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df2[selected_features], df2["Type"], test_size=0.2,
...
user_data = np.array([[Age, Duration, Intensity, Nausea, Vomit, Phonophobia, Photophobia, Visual, Sensory, Vertigo]],
                     dtype=np.float64)
...
save_path = r"C:\Users\nithi\OneDrive\Desktop\App\WebApp\model.pkl"
